...
const isCapitalized = (str) => {
  // Solution code here...
  const regex2 = /\b[A-Z]\w*\b/gm;
  return str.match(regex2) || [];
...
const matchMonth = (input) => {
  // Solution code here...
  const regex4 = /\bOctober\b|\bOct\b|\boctober\b|\boct\b/;
...
let hangman = (str) => {
  // Solution code here...
  const regex6 = /[A,E,I,O,U,a,e,i,o,u]/gm;
  return str.replace(regex6, '_');
};
