...
const setStatusAsAuthor = (people) => people.forEach((x, index) => people[index].isAuthor = true);
...
const append = (arr1, arr2) => arr2.forEach((num) => arr.push(num));
